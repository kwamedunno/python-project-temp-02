...
from python_project_temp_02.ext.auth import create_user
from python_project_temp_02.ext.database import db
from python_project_temp_02.models import Product
