...
- 🎯 Entry points to execute your program using `python -m <python_project_temp_02>` or `$ python_project_temp_02` with basic CLI argument parsing.
...
---
# python_project_temp_02 Flask Application

Awesome python_project_temp_02 created by kwamedunno
...
```bash
git clone https://github.com/kwamedunno/python-project-temp-02 python_project_temp_02
cd python_project_temp_02
make install
```
...
```bash
pip install python_project_temp_02
```
...
```bash
$ python_project_temp_02
```

or

```bash
$ python -m python_project_temp_02
```
...
```bash
python_project_temp_02 create-db   # run once
python_project_temp_02 populate-db  # run once (optional)
python_project_temp_02 add-user -u admin -p 1234  # ads a user
python_project_temp_02 run
```
